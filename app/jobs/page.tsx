            ...
            <div className="max-w-5xl mx-auto px-4 py-5">
                ...
                <div className="bg-white rounded-lg border border-[#e0dfdc] p-4 mb-4">
                    <div className="flex gap-3 flex-wrap sm:flex-nowrap">
                        <div className="flex-1 flex items-center gap-2 border border-gray-300 rounded-md px-3 h-10 focus-within:border-[#0a66c2] transition-colors">
                        ...
                        <div className="flex items-center gap-2 border border-gray-300 rounded-md px-3 h-10 w-full sm:w-48">
                            <svg className="w-4 h-4 text-gray-400 shrink-0" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
                ...
                <div className="flex gap-5 items-start">
                    ...
                    <div className="flex-1 min-w-0 space-y-3">
                        {filtered.length === 0 ? (
                            <div className="bg-white rounded-lg border border-[#e0dfdc] p-8 text-center">
                                ...
                                <p className="text-xs text-gray-400 mt-1">The prey has moved on. Try different filters.</p>
                            </div>
                        ) : (
                    ...
                    <aside className="w-[280px] shrink-0 space-y-3">
                        ...
                        <div className="bg-white rounded-lg border border-[#e0dfdc] p-4">
                            <h2 className="text-sm font-semibold text-gray-900">Jobs you may like</h2>
                            <p className="text-xs text-gray-400 mt-0.5 mb-3">Based on your species: {ME.species}</p>
                        ...
                        {/* Job alert widget */}
                        <div className="bg-white rounded-lg border border-[#e0dfdc] p-4">
                            <p className="text-sm font-semibold text-gray-900 mb-1">Set up a job alert</p>
                            <p className="text-xs text-gray-500 leading-relaxed mb-3">
                                Get notified when new prey — uh, positions — match your profile.
                            </p>
                            <button className="w-full text-xs font-semibold text-[#0a66c2] border border-[#0a66c2] rounded-full py-1.5 hover:bg-blue-50 transition-colors">
                                Create alert
                            </button>
                        </div>
                        ...
                        {/* Stats widget */}
                        <div className="bg-white rounded-lg border border-[#e0dfdc] p-4">
                            <p className="text-xs font-semibold text-gray-500 uppercase tracking-wide mb-3">By the numbers</p>
                            <div className="space-y-2">
                                ...
                                <div className="flex justify-between text-xs">
                                    <span className="text-gray-500">Most competitive</span>
                                    <span className="font-semibold text-gray-800 truncate ml-2 text-right">
